                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row" id="product-gallery">
                            @if($productImages->isNotEmpty())
                                @foreach($productImages as $image)
                                    <div class="col-md-3" id="image_row-{{ $image->id }}">
                                        <div class="card">
                                            <input type="hidden" name="image_array[]" value="{{ $image->id }}">
                                            <img src="{{asset('uploads/product/small/'.$image->image) }}"
                                                 class="card-img-top" alt="...">
                                            <div class="card-body">
                                                <a href="javascript:void(0)" onclick="deleteIaage({{ $image->id }})"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="compare_price" id="compare_price" class="form-control" placeholder="Compare Price" {{ $product->compare_price  }}>
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <select multiple class="related-products w-100" name="related_products[]" id="related_products" class="form-control">
                                        @if(!empty($relatadProducts))
                                            @foreach($relatadProducts as $relProduct)
                                    ...
                                    <select name="sub_category" id="sub_category" class="form-control">
                                        ...
                                        @if($subCategories->isNotEmpty())
                                            @foreach($subCategories as $subCategory)
                                                <option {{ ($product->sub_category_id == $subCategory->id) ?
                                                'selected' : '' }} value="{{ $subCategory->id }}">
