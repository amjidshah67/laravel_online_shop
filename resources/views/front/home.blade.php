    ...
    <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="false">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <!-- <img src="{{-- asset('front/imagest/carousel-1.jpg)'--}}" class="d-block w-100" alt=""> -->
            ...
            <div class="carousel-item">
                <!-- <img src="{{-- asset('front/imagest/carousel-3.jpg') --}}" class="d-block w-100" alt=""> -->
                    ...
                    <div class="col-lg-3">
                        <div class="cat-card">
                            <div class="left">
                                ...
                                @endif
                                {{--                                    <img src="{{ asset('front/images/cat-1.jpg') }}" alt="" class="img-fluid">--}}
                        ...
                        <div class="card product-card">
                            <div class="product-image position-relative">
                                <a href="{{ route('front.product',$product->slug) }}" class="product-img">
                                    ...
                                    @else
                                        <img class="card-img-top" src="{{ asset('front/images/product-1.jpg') }}" alt="">
                                    @endif
                                </a>
