                ...
                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <textarea name="order_notes" id="order_notes" cols="30" rows="2" placeholder="Order Notes (optional)" class="form-control">
                                                      {{ (!empty($customerAddress))? $customerAddress->order_notes : '' }}</textarea>
                                            <p></p>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card payment-form ">
                            ...
                            <div class="card-body p-0 d-none mt-3" id="payment_method_form">
                                <div class="mb-3">
...
<script type="text/javascript">
    $("#payment_method_one").click(function (){
        if ($(this).is(":checked") == true){
            $('#payment_method_form').addClass('d-none');
        }
    })

    $("#payment_method_two").click(function (){
        if ($(this).is(":checked") == true){
            $('#payment_method_form').removeClass('d-none');
        }
    })
// form submit
        ...
        $.ajax({
            ...
            success: function (response) {
                if(response.status == true){
                    ...
                    $("#discount-response-wrapper").html("<span class='text-danger'>"+response.message+"</spam>")
                }
            }
        });
    });
