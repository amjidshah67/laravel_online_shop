...
@section('content')
    ...
    <section class=" section-11 ">
        <div class="container  mt-5">
            <div class="row">
                <div class="col-md-3">
                    @include('front.account.comman.account-panel')
                </div>
                <div class="col-md-9">
                    <div class="card">
                                            ...
                                            <p class="mb-lg-0 fs-sm fw-bold">
                                                <time datetime="2019-10-01">
                                                    @if(!empty($order->shipped_date))
                                                         {{ \Carbon\Carbon::parse($order->shipped_date)->format('d Y,M') }}
                                                    @else
                                                            N/a
                                                    @endif
                                                </time>
                                ...
                                <li class="list-group-item">
                                    <div class="row align-items-center">
                                        <div class="col-4 col-md-3 col-xl-2">
                                            ...
                                            @else
                                                <img class="img-fluid" src="{{ asset('front/images/product-1.jpg') }}" alt="">
                                            @endif
